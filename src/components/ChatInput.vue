    ...
    <div class="typing-content">
      <div class="typing-textarea">
        <textarea
          ...
          v-model="message"
          v-on:keyup.enter="pushMessage(message)"
        ></textarea>
        <span id="send-btn" class="material-symbols-rounded" @click="pushMessage(message)">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
      ...
      <div class="typing-controls">
		...
		<span id="delete-btn" class="material-symbols-rounded">Clear Chat</span>
      </div>
    </div>
  </div>
</template>
